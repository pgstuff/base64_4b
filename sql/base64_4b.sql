...
LANGUAGE C IMMUTABLE STRICT;
CREATE OR REPLACE FUNCTION text_to_base64_4b(text) RETURNS base64_4b AS '$libdir/base64_4b'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE CAST (text AS base64_4b) WITH FUNCTION text_to_base64_4b(text) AS ASSIGNMENT;
